...
//Postcondition: On SUCCESS pLeft will contain the address of a handle to a valid MY_STRING object  // that is a deep copy of the object indicated by Right. If the value of the handle at the address
// indicated by pLeft is originally NULL then the function will attempt to initialize a new object
// that is a deep copy of the object indicated by Right, otherwise the object indicated by the
// handle at the address pLeft will attempt to resize to hold the data in Right. On failure pLeft
// will be left as NULL and any memory that may have been used by a potential object indicated by
// pLeft will be returned to the freestore.
